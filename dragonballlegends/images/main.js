$(document).ready(function() {	
	...
	var select = $( "#Chrono Crystals-amount-wrapper" );
	var slider = $( "<div id='slider-Chrono Crystals'></div>" ).insertAfter( select ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-Chrono Crystals" ).slider( "option", "value" );				
			$('#Chrono Crystals-amount').html(sliderValue);
			if(sliderValue == '100000') {
				progressBar(20, $('#progressBar'));
				$('#decrease-Chrono Crystals').addClass('btn-disabled');
				$('.max-amount-Chrono Crystals').fadeOut();
			}
			else if (sliderValue == '250000') {
				progressBar(40, $('#progressBar'));
				$('#decrease-Chrono Crystals').removeClass('btn-disabled');
			}
			else if (sliderValue == '550000') {
				progressBar(60, $('#progressBar'));
			}
			else if (sliderValue == '700000') {
				progressBar(80, $('#progressBar'));
				$('#increase-Chrono Crystals').removeClass('btn-disabled');
				$('.max-amount-Chrono Crystals').fadeOut();
			}
			else if (sliderValue == '999999') {
				progressBar(100, $('#progressBar'));
				$('#increase-Chrono Crystals').addClass('btn-disabled');
				$('.max-amount-Chrono Crystals').fadeIn();
			}
		}        
	});	
	
	$('#increase-Chrono Crystals').click(function() {
	var sliderCurrentValue = $( "#slider-Chrono Crystals" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 150000 );
	});

	$('#decrease-Chrono Crystals').click(function() {
	var sliderCurrentValue = $( "#slider-Chrono Crystals" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue - 150000 );
	});

	function progressBarChrono Crystals(percent, $element) {
		var progressBarChrono CrystalsWidth = percent * $element.width() / 100;
		$element.find('div').animate({ width: progressBarChrono CrystalsWidth }, 500).html(percent + "%&nbsp;");
	}
	progressBarChrono Crystals(20, $('#progressBarChrono Crystals'));
	var selectChrono Crystals = $( "#Chrono Crystals-amount-wrapper" );
	var sliderChrono Crystals = $( "<div id='slider-Chrono Crystals'></div>" ).insertAfter( selectChrono Crystals ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
				var sliderValueChrono Crystals = $( "#slider-Chrono Crystals" ).slider( "option", "value" );
				$('#Chrono Crystals-amount').html(sliderValueChrono Crystals);
					if(sliderValueChrono Crystals == '100000') {
						progressBarChrono Crystals(20, $('#progressBarChrono Crystals'));
						$('#decrease-Chrono Crystals').addClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueChrono Crystals == '250000') {
						progressBarChrono Crystals(40, $('#progressBarChrono Crystals'));
						$('#decrease-Chrono Crystals').removeClass('btn-disabled');
					}
					else if (sliderValueChrono Crystals == '550000') {
						progressBarChrono Crystals(60, $('#progressBarChrono Crystals'));
					}
					else if (sliderValueChrono Crystals == '700000') {
						progressBarChrono Crystals(80, $('#progressBarChrono Crystals'));
						$('#increase-Chrono Crystals').removeClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueChrono Crystals == '999999') {
						progressBarChrono Crystals(100, $('#progressBarChrono Crystals'));
						$('#increase-Chrono Crystals').addClass('btn-disabled');
	...
	$('#increase-Chrono Crystals').click(function() {
		var sliderCurrentChrono CrystalsValue = $( "#slider-Chrono Crystals" ).slider( "option", "value" );
		sliderChrono Crystals.slider( "value", sliderCurrentChrono CrystalsValue + 150000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				var $console_message_Chrono Crystals_msg = $('#slider-Chrono Crystals').slider("option", "value");
				var $console_message_Chrono Crystals_msg = $('#slider-Chrono Crystals').slider("option", "value");			
				...
				setTimeout(function() { 
					$console_message.html("Creating packages for Chrono Crystals");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 11000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_Chrono Crystals_msg + "</span> Chrono Crystals");
					$('.console-Chrono Crystals-wrapper').fadeIn(500, function() {
						var $console_Chrono Crystals_countto = $('#slider-Chrono Crystals').slider("option", "value");
						$('#console-Chrono Crystals-value').countTo({
							from: 0,
							to: $console_Chrono Crystals_countto,
							speed: 2500,
							refreshInterval: 10,
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_Chrono Crystals_msg + "</span> <span class='console-message-success'>Chrono Crystals successfully generated</span>");
					$('#console-success-confirmation-Chrono Crystals').fadeIn();
					$(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
						$(this).removeClass('pulse animated');
					});
