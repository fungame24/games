$(document).ready(function() {	
	...
	var select = $( "#Gold-and-Cash-amount-wrapper" );
	var slider = $( "<div id='slider-Gold-and-Cash'></div>" ).insertAfter( select ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-Gold-and-Cash" ).slider( "option", "value" );				
			$('#Gold-and-Cash-amount').html(sliderValue);
			if(sliderValue == '100000') {
				progressBar(20, $('#progressBar'));
				$('#decrease-Gold-and-Cash').addClass('btn-disabled');
				$('.max-amount-Gold-and-Cash').fadeOut();
			}
			else if (sliderValue == '250000') {
				progressBar(40, $('#progressBar'));
				$('#decrease-Gold-and-Cash').removeClass('btn-disabled');
			}
				...
				$('#increase-Gold-and-Cash').removeClass('btn-disabled');
				$('.max-amount-Gold-and-Cash').fadeOut();
			}
			else if (sliderValue == '999999') {
				progressBar(100, $('#progressBar'));
				$('#increase-Gold-and-Cash').addClass('btn-disabled');
				$('.max-amount-Gold-and-Cash').fadeIn();
			}
		}        
	});	
	
	$('#increase-Gold-and-Cash').click(function() {
	var sliderCurrentValue = $( "#slider-Gold-and-Cash" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 150000 );
	});

	$('#decrease-Gold-and-Cash').click(function() {
	var sliderCurrentValue = $( "#slider-Gold-and-Cash" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue - 150000 );
	});

	function progressBarGold-and-Cash(percent, $element) {
		var progressBarGold-and-CashWidth = percent * $element.width() / 100;
		$element.find('div').animate({ width: progressBarGold-and-CashWidth }, 500).html(percent + "%&nbsp;");
	}
	progressBarGold-and-Cash(20, $('#progressBarGold-and-Cash'));
	var selectGold-and-Cash = $( "#Gold-and-Cash-amount-wrapper" );
	var sliderGold-and-Cash = $( "<div id='slider-Gold-and-Cash'></div>" ).insertAfter( selectGold-and-Cash ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
				var sliderValueGold-and-Cash = $( "#slider-Gold-and-Cash" ).slider( "option", "value" );
				$('#Gold-and-Cash-amount').html(sliderValueGold-and-Cash);
					if(sliderValueGold-and-Cash == '100000') {
						progressBarGold-and-Cash(20, $('#progressBarGold-and-Cash'));
						$('#decrease-Gold-and-Cash').addClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueGold-and-Cash == '250000') {
						progressBarGold-and-Cash(40, $('#progressBarGold-and-Cash'));
						$('#decrease-Gold-and-Cash').removeClass('btn-disabled');
					}
					else if (sliderValueGold-and-Cash == '550000') {
						progressBarGold-and-Cash(60, $('#progressBarGold-and-Cash'));
					}
					else if (sliderValueGold-and-Cash == '700000') {
						progressBarGold-and-Cash(80, $('#progressBarGold-and-Cash'));
						$('#increase-Gold-and-Cash').removeClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueGold-and-Cash == '999999') {
						progressBarGold-and-Cash(100, $('#progressBarGold-and-Cash'));
						$('#increase-Gold-and-Cash').addClass('btn-disabled');
	...
	$('#increase-Gold-and-Cash').click(function() {
		var sliderCurrentGold-and-CashValue = $( "#slider-Gold-and-Cash" ).slider( "option", "value" );
		sliderGold-and-Cash.slider( "value", sliderCurrentGold-and-CashValue + 150000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				var $console_message_Gold-and-Cash_msg = $('#slider-Gold-and-Cash').slider("option", "value");
				var $console_message_Gold-and-Cash_msg = $('#slider-Gold-and-Cash').slider("option", "value");			
				...
				setTimeout(function() { 
					$console_message.html("Creating packages for Gold-and-Cash");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 11000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_Gold-and-Cash_msg + "</span> Gold-and-Cash");
					$('.console-Gold-and-Cash-wrapper').fadeIn(500, function() {
						var $console_Gold-and-Cash_countto = $('#slider-Gold-and-Cash').slider("option", "value");
						$('#console-Gold-and-Cash-value').countTo({
							from: 0,
							to: $console_Gold-and-Cash_countto,
							speed: 2500,
							refreshInterval: 10,
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_Gold-and-Cash_msg + "</span> <span class='console-message-success'>Gold-and-Cash successfully generated</span>");
					$('#console-success-confirmation-Gold-and-Cash').fadeIn();
					$(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
						$(this).removeClass('pulse animated');
					});
