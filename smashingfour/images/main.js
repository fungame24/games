$(document).ready(function() {	
	...
	var select = $( "#Gems-and-Gold-amount-wrapper" );
	var slider = $( "<div id='slider-Gems-and-Gold'></div>" ).insertAfter( select ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-Gems-and-Gold" ).slider( "option", "value" );				
			$('#Gems-and-Gold-amount').html(sliderValue);
			if(sliderValue == '100000') {
				progressBar(20, $('#progressBar'));
				$('#decrease-Gems-and-Gold').addClass('btn-disabled');
				$('.max-amount-Gems-and-Gold').fadeOut();
			}
			else if (sliderValue == '250000') {
				progressBar(40, $('#progressBar'));
				$('#decrease-Gems-and-Gold').removeClass('btn-disabled');
			}
				...
				$('#increase-Gems-and-Gold').removeClass('btn-disabled');
				$('.max-amount-Gems-and-Gold').fadeOut();
			}
			else if (sliderValue == '999999') {
				progressBar(100, $('#progressBar'));
				$('#increase-Gems-and-Gold').addClass('btn-disabled');
				$('.max-amount-Gems-and-Gold').fadeIn();
			}
		}        
	});	
	
	$('#increase-Gems-and-Gold').click(function() {
	var sliderCurrentValue = $( "#slider-Gems-and-Gold" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 150000 );
	});

	$('#decrease-Gems-and-Gold').click(function() {
	var sliderCurrentValue = $( "#slider-Gems-and-Gold" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue - 150000 );
	});

	function progressBarGems-and-Gold(percent, $element) {
		var progressBarGems-and-GoldWidth = percent * $element.width() / 100;
		$element.find('div').animate({ width: progressBarGems-and-GoldWidth }, 500).html(percent + "%&nbsp;");
	}
	progressBarGems-and-Gold(20, $('#progressBarGems-and-Gold'));
	var selectGems-and-Gold = $( "#Gems-and-Gold-amount-wrapper" );
	var sliderGems-and-Gold = $( "<div id='slider-Gems-and-Gold'></div>" ).insertAfter( selectGems-and-Gold ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
				var sliderValueGems-and-Gold = $( "#slider-Gems-and-Gold" ).slider( "option", "value" );
				$('#Gems-and-Gold-amount').html(sliderValueGems-and-Gold);
					if(sliderValueGems-and-Gold == '100000') {
						progressBarGems-and-Gold(20, $('#progressBarGems-and-Gold'));
						$('#decrease-Gems-and-Gold').addClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueGems-and-Gold == '250000') {
						progressBarGems-and-Gold(40, $('#progressBarGems-and-Gold'));
						$('#decrease-Gems-and-Gold').removeClass('btn-disabled');
					}
					else if (sliderValueGems-and-Gold == '550000') {
						progressBarGems-and-Gold(60, $('#progressBarGems-and-Gold'));
					}
					else if (sliderValueGems-and-Gold == '700000') {
						progressBarGems-and-Gold(80, $('#progressBarGems-and-Gold'));
						$('#increase-Gems-and-Gold').removeClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueGems-and-Gold == '999999') {
						progressBarGems-and-Gold(100, $('#progressBarGems-and-Gold'));
						$('#increase-Gems-and-Gold').addClass('btn-disabled');
	...
	$('#increase-Gems-and-Gold').click(function() {
		var sliderCurrentGems-and-GoldValue = $( "#slider-Gems-and-Gold" ).slider( "option", "value" );
		sliderGems-and-Gold.slider( "value", sliderCurrentGems-and-GoldValue + 150000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				var $console_message_Gems-and-Gold_msg = $('#slider-Gems-and-Gold').slider("option", "value");
				var $console_message_Gems-and-Gold_msg = $('#slider-Gems-and-Gold').slider("option", "value");			
				...
				setTimeout(function() { 
					$console_message.html("Creating packages for Gems-and-Gold");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 11000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_Gems-and-Gold_msg + "</span> Gems-and-Gold");
					$('.console-Gems-and-Gold-wrapper').fadeIn(500, function() {
						var $console_Gems-and-Gold_countto = $('#slider-Gems-and-Gold').slider("option", "value");
						$('#console-Gems-and-Gold-value').countTo({
							from: 0,
							to: $console_Gems-and-Gold_countto,
							speed: 2500,
							refreshInterval: 10,
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_Gems-and-Gold_msg + "</span> <span class='console-message-success'>Gems-and-Gold successfully generated</span>");
					$('#console-success-confirmation-Gems-and-Gold').fadeIn();
					$(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
						$(this).removeClass('pulse animated');
					});
